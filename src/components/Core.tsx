export default function Core() {
  const highlights = [
    {
      title: "五大指標企業真實出題",
      desc: "全聯、全家、Alpha 阿爾法與聲寶頑味共同出題，提供企業專題、業師指導與就業職缺。",
    },
    {
      title: "企業出題 × 學員解題",
  ...
  const abilities = [
    ...
    {
      title: "零售餐飲場域理解",
      desc: "由全聯、全家、Alpha 阿爾法與聲寶頑味等一線企業業師親自引導，深度理解零售與餐飲營運型態，全面掌握智慧門市、AI 節力與會員經營的真實專題開發標準。",
    },
    {
      title: "顧客旅程分析",
      desc: "透過工作坊演練與實地門市或餐飲場域觀察，學會盤點購物、取貨、點餐、候位、鮮食購買等多元接觸點，精準找出科技賦能的關鍵轉型改善機會。",
    },
  ]
  ...
  return (
    <>
      ...
      <section className="px-5 py-[5rem] flex flex-col justify-center items-center bg-[var(--gray-bg)]">
        ...
        <h4 className="mt-2 text-center text-slate-400">不談純理論！我們只培養企業爭相招募的「服務業 AI 應用型人才」。</h4>
