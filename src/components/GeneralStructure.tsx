  ...
  const data = [
    {
      ...
      items: [
        { title: "🛠️ 模組一：AI 職場生產力與行銷應用", desc: "撰寫商務郵件、政府計畫書、精準行銷文案、提案簡報架構，並實戰短影音行銷創作。" },
        { title: "🤝 模組二：職場軟實力與就業輔導", desc: "培養關鍵溝通應對、形象禮儀與客訴救火心法。同步執行 AI 履歷優化與模擬面試。" },
        { title: "⚙️ 模組三：AI 工作流自動化與資安法遵", desc: "精修 SDD 規格工程、API 串接與 RAG 企業知識庫，融入法學院核心個資去識別化素養。" },
        { title: "🎓 模組四：n8n Level 1 國際認證輔導", desc: "針對官方 Level 1 進行國際應考輔導，訓後即刻衝刺考照，在履歷刻下國際認證。" },
      ],
    },
    {
      ...
      items: [
        ...
        { title: "🗺️ 單元二：門市顧客旅程與流程盤點", desc: "分組實地走入門市實務考察，細緻盤點購物、取貨、點餐等顧客接觸點之服務痛點與科技機會。" },
        { title: "💻 單元三：AI 應用原型與為數據開發", desc: "在業師指導下，利用 n8n/RAG 工具實作客製化 AI 客服流程、預測儀表板或門市 SOP 助理。" },
        { title: "🏆 單元四：成果發表大會與就業媒合", desc: "期末成果盛大發表，合作企業高層人資親臨現場進行直接面談，無縫對接 85+ 實務優質職缺。" },
      ],
    }
  ]
  return (
