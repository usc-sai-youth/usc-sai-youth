...
export default function FAQ() {
  const faqs = [
    ...
    {
      q: "兩個班別有什麼差異？可以都報名嗎？",
      a: "養成班一聚焦零售場域，養成班二聚焦餐飲場域。報名時可擇一或勾選皆可，最終依甄選結果與時程安排。",
    },
    {
      q: "上課時間、地點與時數是？",
      a: "於 實踐大學-台北校區 開課，總計 240 小時，分為「次產業 AI 應用課程」與「企業專題實作」兩階段，各 120 小時。",
    },
    {
      q: "完訓資格如何認定？",
      a: (
        <>
          第一階段（次產業 AI 應用課程）結業標準：訓練課程出席時數達該階段總課程時數 90% 以上，且測驗成績達 80 分以上。
          <br />
          第二階段（企業專題實作課程）結業標準：實作課程出席時數達該階段總課程時數 90% 以上，並交付專題成果報告、完成專題成果發表，經培訓單位及企業業師聯合評核通過。
        </>
      ),
    },
    {
      q: "完訓後有就業媒合嗎？",
      a: "合作企業提供多個就業職缺，透過成果發表與企業面談進行媒合，計畫以 75% 就業媒合率為目標，並於完訓後提供職涯追蹤輔導。",
    },
    {
      q: "培訓期間可以同時領其他政府補助嗎？",
